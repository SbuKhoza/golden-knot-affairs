    ...
    <form onSubmit={handleSubmit} className="max-w-3xl space-y-8" noValidate>
      ...
      <section className="rounded-xl border border-border bg-card p-6">
        ...
        <div className="mt-6 rounded-lg border border-border/60 p-4">
          ...
          <div className="mt-4">
            <Field label="Ceremony location link (optional)" htmlFor="ws-ceremony-map">
              <input
                id="ws-ceremony-map"
                type="url"
                inputMode="url"
                ...
                value={values.ceremonyVenueMapUrl}
                onChange={(e) => update("ceremonyVenueMapUrl", e.target.value)}
              />
              <p className="mt-1 text-xs text-muted-foreground">
                Paste a Google Maps, Apple Maps, or Waze link. Guests see it as "View on map" on the invitation page and PDF; if left blank we build one automatically from the address above.
              </p>
            </Field>
          </div>
        </div>
        ...
        <div className="mt-4 rounded-lg border border-border/60 p-4">
          ...
          <div className="mt-4">
            <Field label="Reception location link (optional)" htmlFor="ws-reception-map">
              <input
                id="ws-reception-map"
                type="url"
                inputMode="url"
                placeholder="https://maps.app.goo.gl/..."
                className={inputClass}
                value={values.receptionVenueMapUrl}
                onChange={(e) => update("receptionVenueMapUrl", e.target.value)}
              />
              <p className="mt-1 text-xs text-muted-foreground">
                Paste a Google Maps, Apple Maps, or Waze link. Guests see it as "View on map" on the invitation page and PDF; if left blank we build one automatically from the address above.
              </p>
