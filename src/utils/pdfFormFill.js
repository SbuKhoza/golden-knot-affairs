...
const FIELD_STYLES = {
  username: { fontSize: 5.5, minFontSize: 5.5, textColor: WARM_CHARCOAL },
  ceremonyVenueName: { fontSize: 5.5, minFontSize: 6.5, textColor: WARM_CHARCOAL },
  receptionVenueName: { fontSize: 5.5, minFontSize: 6.5, textColor: WARM_CHARCOAL },
  ...
  additionalMessage: { fontSize: 5.5, minFontSize: 6.5, textColor: WARM_CHARCOAL },
};
